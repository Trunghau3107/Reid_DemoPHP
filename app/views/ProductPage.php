                       ...
                       <!--sidebar widget start-->
                        <div class="sidebar_widget">
                            ...
                            if (!isset($_GET['danhmuc'])) {
                                echo '<div class="widget_list widget_categories">
                                <a href="/product"><h2>Danh mục sản phẩm</h2></a>';
                            }else{
                                echo '<div class="widget_list widget_categories">
                                <a href="/product"><h2>Danh mục sản phẩm</h2></a>';
                            }
                            ...
                            foreach ($danhmuc as $danhmuc) {
                                if (isset($_GET['danhmuc']) && $_GET['danhmuc'] == $danhmuc->id) {
                                    echo '<ul>
                                    <li><a href="/product?danhmuc=' . $danhmuc->id . '">' . $danhmuc->namedm. ' <span>' . $danhmuc->stt. '</span></a> </li>
                                    </ul>';
                                }else{
                                    echo '<ul>
                                    <li><a href="/product?danhmuc=' . $danhmuc->id . '">' . $danhmuc->namedm. ' <span>' . $danhmuc->stt. '</span></a> </li>
                            ...
                            <div class="col-lg-4 col-md-4 col-12 ">
                                <div class="single_product">
                                    <div class="product_thumb">
                                        ...
                                        <a class="secondary_img" href="product-details.html"><img src="../../public/img/product/product16.jpg" alt=""></a>
