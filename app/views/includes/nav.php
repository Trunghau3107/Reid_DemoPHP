...
<body>
        ...
        <div class="offcanvas_menu_wrapper">
            ...
            <div class="top_right">
                <ul>
                    <li class="top_links"><a href="#">Tài Khoản <i class="ion-chevron-down"></i></a>
                        <ul class="dropdown_links">
                            <li><a href="wishlist.html">Đăng Kí </a></li>
                            <li><a href="my-account.html">My Account </a></li>
                            <li><a href="#">Sign In</a></li>
                            <li><a href="compare.html">Compare Products </a></li>
                        </ul>
                    </li>
                    <li class="language"><a href="#"><img src="../../public/img/logo/language.png" alt=""> English <i
                                class="ion-chevron-down"></i></a>
                        <ul class="dropdown_language">
                            <li><a href="#"><img src="../../public/img/logo/cigar.jpg" alt=""> French</a></li>
                            <li><a href="#"><img src="../../public/img/logo/language2.png" alt="">German</a></li>
                        </ul>
                    </li>
    ...
    <header class="header_area header_three">
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-12">
                        <div class="welcome_text">
                            <ul>
                                <li><span>Miễn phí vận chuyển *</span> Chỉ áp dụng với con gái tốt</li>
                                <li><span>Hoàn trả miễn phí *</span> Đảm bảo hài lòng!</li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <ul>
                                    ...
                                    <li class="mega_items"><a href="shop.html">shop <i class="fa fa-angle-down"></i></a>
                                        <ul class="mega_menu">
                                            ...
                                            <li class="banner_menu"><a href="#"><img src="../../public/img/bg/banner1.jpg"
                                                        alt=""></a></li>
                                        </ul>
                                    </li>
        ...
        <!--header bottom satr___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________-->
