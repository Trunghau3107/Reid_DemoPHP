...
<body>
    ...
    <header class="header_area header_product">
        ...
        <!--header bottom satrt________________________________________________________________________________________________________-->
                                ...
                                <div class="main_menu"> 
                                    <nav>  
                                        <ul>
                                            ...
                                            <li class="mega_items active"><a href="/product">Sản phẩm <i class="fa fa-angle-down"></i></a>
                                                <ul class="mega_menu">
